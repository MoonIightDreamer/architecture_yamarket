...
По данным Mediascope (июнь 2025):
- MAU = 44.5 млн  
- DAU = 8.3 млн  
...
- 7 заказов в год на пользователя (DataInsight)  
- 2 товара в заказе (AdIndex)  
- 50% товаров имеют отзывы  
- 10 товаров в избранном  
...
$$
CPX_{шт} = 7 \cdot (offers + 2 \cdot offer\_cards) + reviews + favorites + user + address
$$
...
$$
CPX_{B} = 7 \cdot 1624 + 3000 = 7168 + 3000 = 10168 = 10^{-5} \ \text{B}
$$
